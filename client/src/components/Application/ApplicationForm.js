      ...
      <MDBRow>
        <MDBCol>
          <form  onSubmit={handleSubmit(onSubmit)}>
            ...
            <MDBInput autoComplete="off" style={{marginBottom:"5px" }} name="Application_Name" valueDefault = {props.type === "update" ? props.record.Application_Name : ""} inputRef={register({ required: true, maxLength: 255 })   }  label="Application Name"  group type="text"  validate error="wrong" success="right" />
            ...
            <MDBInput autoComplete="off" style={{marginBottom:"5px" }} name ="Application_Short_Name" valueDefault = {props.type === "update" ? props.record.Application_Short_Name : ""} inputRef={register({ required: true, maxLength: 255 })   }  label="Application Short Name"  group type="text"  validate error="wrong" success="right" />
            ...
            <MDBInput autoComplete="off" style={{marginBottom:"5px" }} name="Application_Desc" valueDefault = {props.type === "update" ? props.record.Application_Desc : ""} inputRef={register({ required: true, maxLength: 500 })   }  label="Application Description"  group type="text"  validate error="wrong" success="right" />
